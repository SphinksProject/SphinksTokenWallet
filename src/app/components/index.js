...
// Set exchange-data component
import ExchangeData from './exchangeData.component';
componentsModule.component('exchangeData', ExchangeData);

// Set queue-data component
import QueueData from './queueData.component';
componentsModule.component('queueData', QueueData);
