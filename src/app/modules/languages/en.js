function EnglishProvider($translateProvider) {
    ...
    $translateProvider.translations('en', {
        ...
        DASHBOARD_NOTICE_1: 'Welcome to the Sphinks Token Wallet Beta!',
        DASHBOARD_NOTICE_2: 'Please <a href="https://github.com/NemProject/NanoWallet" target="_blank">report issues here</a>.',
        DASHBOARD_NOTICE_3: 'The NEM Team suggests primarily testing on the testnet to familiarize yourself with the Sphinks Token Wallet first before using the mainnet. A simple guide can be found <a href="https://blog.nem.io/nanowallet-tutorial/" target="_blank">here</a>. Users are responsible for their funds and having their private keys backed up. The NEM team is not responsible for any loss of funds due to using this app on the mainnet.',
        ...
        GENERAL_SEND: 'Send',
        GENERAL_EXCHANGE: 'Exchange',
        GENERAL_POST_EXCHANGE_REQUEST: 'Post exchange request',
        GENERAL_TOKEN_ISSUANCE: 'Token Issuance',
        GENERAL_TO: 'To',
        GENERAL_HASH: 'Hash',
        ...
        // HOME MODULE
        HOME_UNSUPPORTED_BROWSER: 'Sorry but you cannot use Sphinks Token Wallet safely with this browser...',
        ...
        // EXCHANGE TRANSACTION MODULE
        EXCHANGE_TRANSACTION_TITLE: 'Sphinks token issuance system',
        EXCHANGE_REQUEST_NAME: 'Token Exchange Request',
        EXCHANGE_REQUEST_FORM: 'Request form',
        EXCHANGE_BITCOIN: "Bitcoin",
        EXCHANGE_ETHEREUM: "Ethereum",
        EXCHANGE_MESSAGE: "Message",
        EXCHANGE_STATUS: "Status",
        EXCHANGE_ID: "ID",
        EXCHANGE_INFO_TITLE: 'Exchange rates',
        EXCHANGE_SENDER: "sender",
        EXCHANGE_RECEIVER: "receiver",
        EXCHANGE_BTC_ADDRESS: 'Bitcoin funds sender address (must be a Legacy Bitcoin address)',
        EXCHANGE_ETH_ADDRESS: 'Ethereum funds sender address',
        EXCHANGE_ETH_NOT_SUPPORTED: 'Not currently supported',
        EXCHANGE_QUEUE_INFO_TITLE: 'Queue',
        EXCHANGE_QUEUE_SIZE: 'Size',

        EXCHANGE_REQUEST_HISTORY: 'Request history',
        EXCHAGE_REQUEST_ID: 'Request ID',
        EXCHAGE_REQUEST_STATE: 'State',
        EXCHAGE_REQUEST_MESSAGE: 'Message',
        EXCHAGE_REQUEST_ACTIVE_UNTIL: 'Active until',

        EXCHANGE_WARNING: "Your trade amount is calculated at the time of the order executing within the queue system. Please send the funds you are trading for Sphinks Tokens to the relevant receive address as displayed on the token issuance page.\nNote: Only send a single transaction to the order you are about to create. For multiple transactions, please create separate orders; otherwise, your initial order may finalize before a second transaction is confirmed, resulting in your funds being returned to you. Please also ensure your funds are sending from a single address or only part of your order may be filled with the rest being automatically returned to you.",
        EXCHANGE_NOTICE_1: "How the system operates",
        EXCHANGE_NOTICE_2: "",
        EXCHANGE_NOTICE_3: "Cryptocurrencies (crypto’s) can be exchanged for new Sphinks Tokens. Trade requests are established by sending a zero-sum transaction from the token issuance page and including the address where the crypto being traded is sent from. A small amount of XEM is required to cover the NEM network fee. After creating an order, there is a 14-day window for crypto’s to be received and confirmed by the system before the order is cancelled (any cryptocurrencies received by the system that do not have an open order are automatically returned). Received crypto’s require a confirmation time of approximately 1 hour before entering a queue with other orders whereby each trade is executed at a maximum of 2,000 Sphinks Tokens before the system executes on the next order in queue; an order is complete when the queue has repeated enough times to clear the order total. The system is rate limited to 1 transaction per second and trade amounts are calculated as they are executed upon.",
        EXCHANGE_NOTICE_4: "1.	Obtain XEM to cover transaction fees when posting orders.",
        EXCHANGE_NOTICE_5: "2.	Enter BTC/ETH address from where you are sending your funds.",
        EXCHANGE_NOTICE_6: "3.	Post the exchange request.",
        EXCHANGE_NOTICE_7: "4.	Send your funds to the BTC/ETH receiver address as listed on the Token Issuance page.",
        EXCHANGE_NOTICE_8: "5.	Wait for your transaction to confirm and process through the queue. The request history tab shows the status of your order.",
        EXCHANGE_NOTICE_9: "Please note: Due to initial development processes, we are unable to process Bitcoin funds received via Segregated Witness (SegWit) addresses. Support to allow the creation of Ethereum orders will be added shortly. We are also currently unable to provide token issuance services to persons within either America or Australia.",
        ...
        ALERT_GET_RATES_INFO_ERROR: 'An error occured while trying to fetch rates information!',
        ALERT_GET_QUEUE_INFO_ERROR: 'An error occured while trying to fetch queue information!',
        ALERT_CAPS_LOCK_ON_ERROR: "CapsLock is ON!",
        ...
        FAQ_TITLE_2: '',
        FAQ_QUESTION_1: 'How the Sphinks Token Wallet works?',
        FAQ_ANSWER_1: 'The Sphinks Token Wallet is built with AngularJS and ES6. It is a full client-side application that never sends any sensitive data through the wire; everything happens in your browser from creating private keys to the signing of transactions. The wallet connects to the NEM platform, allowing you to transact with any token (Mosaic) across the NEM platform, including Sphinks Tokens.',
