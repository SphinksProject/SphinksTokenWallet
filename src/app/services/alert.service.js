export default class Alert {
    ...
    errorGetRatesInfo() {
        this._ngToast.create({
            content: this._$filter('translate')('ALERT_GET_RATES_INFO_ERROR'),
            className: 'danger'
        });
    }
    ...
    errorGetQueueInfo() {
        this._ngToast.create({
            content: this._$filter('translate')('ALERT_GET_QUEUE_INFO_ERROR'),
            className: 'danger'
        });
    }
    ...
    warningCapsLockON() {
        this._ngToast.create({
            content: this._$filter('translate')('ALERT_CAPS_LOCK_ON_ERROR'),
            className: 'warning',
