...
## Version 0.5.0
    ...
    - Initial Sphinks Token Wallet release.
    - Added CasLock warning to login page.
    - Added ability to login with Enter after entering password.
    - Added Token Issuance page.
    - Added Token Issuance System connectivity.
    - Updated FAQ - "How the Sphinks Token Wallet works".
    - Updated logos and names.
    - Updated README information.
    - Removed Market information from Dashboard and Services pages.
    - Removed Introduction from Dashboard page.
    - Other minor updates.
